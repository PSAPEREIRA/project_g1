...
class GetTheDayWithHighestTemperatureAmplitudeRestControllerTest {
    ...
    private GetTheDayWithHighestTemperatureAmplitudeRestController ctrl;
    ...
    void initUseCase() {
        ...
        ctrl = new GetTheDayWithHighestTemperatureAmplitudeRestController(houseDomainService, geographicAreaDomainService);
    }


    @Test
    void getDayWithHighestTemperatureAmplitude(){
        //Arrange
        ...
        ResponseEntity<Object> result = ctrl.getDayWithHighestTemperatureAmplitude(startDate, finalDate);
        //ASSERT
    ...
    void getHighestTemperatureAmplitude() throws Exception {
        ...
        s1.setListOfReadings(lRead1);
        geographicAreaDomainService.add(geographicArea);
        ResponseEntity<Object> result  = ctrl.getHighestTemperatureAmplitude(startDate, finalDate);
