...
@Controller
public class GetTheDayWithHighestTemperatureAmplitudeController {
    ...
    @Autowired
    public GetTheDayWithHighestTemperatureAmplitudeController(HouseDomainService houseDomainService, GeographicAreaDomainService geographicAreaDomainService) {
    ...
    public List<LocalDate> getDayWithHighestTemperatureAmplitude(LocalDate initialDate, LocalDate finalDate) {
        return geographicAreaDomainService.getDayWithHighestTemperatureAmplitude(houseDomainService.getGeographicAreaID(), houseDomainService.getLocation(), new SensorType(TEMPERATURE), initialDate, finalDate);
    }

    public double getHighestTemperatureAmplitude(LocalDate initialDate, LocalDate finalDate) {
        return geographicAreaDomainService.getHighestTemperatureAmplitude(houseDomainService.getGeographicAreaID(), houseDomainService.getLocation(), new SensorType(TEMPERATURE), initialDate, finalDate);
    }
